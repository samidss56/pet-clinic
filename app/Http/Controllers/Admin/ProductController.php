...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/products')->with(['message' => 'Product Added Successfully!', 'product' => $product], 201);
    }
    ...
    public function destroy(Product $product)
    {
        Storage::disk('public')->delete($product->image_product);
        $product->delete();
        return redirect('/admin/products')->with(['message' => 'Product Deleted Successfully!', 'product' => $product], 200);
    }
}
