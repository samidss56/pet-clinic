export function UsersIcon() {
    return (
        <svg
            ...
            width="24"
            height="24"
            className="main-grid-item-icon stroke-primary-red"
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
...
export function SchedulesIcon() {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-6 h-6 fill-primary-red"
        >
            <path
                fillRule="evenodd"
...
export function OpenSidebarIcon() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
...
export function ArrowBottomIcons() {
    return (
        <svg
...
export function PendapatanIcon() {
    return (
        <svg
            ...
            strokeWidth="2"
        >
            <line x1="18" x2="18" y1="20" y2="10" className="stroke-primary-red" />
            <line x1="12" x2="12" y1="20" y2="4" className="stroke-primary-red" />
            <line x1="6" x2="6" y1="20" y2="14" className="stroke-primary-red" />
        </svg>
    );
}
...
export function WhyUsIcon({ color }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
