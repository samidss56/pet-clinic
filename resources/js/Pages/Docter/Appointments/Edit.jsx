...
const Edit = ({ docter, auth, title, appointmen, services, products }) => {
  ...
  const { data, setData, errors } = useForm({
    ...
    productList: [{ product_id: "", name_product: "", price_product: products[0].price_product, stock_product: products[0].stock_product, qty: 0, total_price: 0 }],
  });
        ...
        <div className="w-full mx-auto sm:px-2 lg:px-4">
          ...
          >
            <TextInput
              ...
              onChange={(e) => setData("appointmen_id", e.target.value)}
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-1">
              <div>
                ...
                <TextInput
                  ...
                  required
                />
                <InputError message={errors.temperature} className="mb-2" />
              </div>
              <div>
                ...
                <TextInput
                  ...
                  required
                />
                <InputError message={errors.advice} className="mb-2" />
              </div>
            </div>
            ...
            <div>
                ...
                {data.serviceList.map((service, index) => (
                    ...
                    >
                        ...
                        >
                            {serviceOption.name_service} - {serviceOption.price_service}
                        </option>
                        ))}
                    </select>
                ...
                <div key={index} className="mb-4 flex items-center gap-2">
                    ...
                    {products.map((productOption) => (
                        ...
                        >
                        {productOption.name_product} - {productOption.price_product}
                        </option>
                    ))}
                    </select>
            ...
            <div className="flex gap-3 mt-4">
              ...
              {appointmen.data.status === 'finished' || appointmen.data.status == 'handled' ? 
              null :  <PrimaryButton type="submit" onClick={handleSubmit}>
                Update Appoitments
              </PrimaryButton>}
            </div>
