...
const Edit = ({ auth, title, transaction, transactionDetails, services, products, appointment, owner}) => {
  ...
  const { data, setData, errors } = useForm({
      ...
      productList: transactionDetails
        ...
        .map((detail) => ({
          ...
          stock_product: products.find(product => product.product_id === detail.product_id)?.stock_product || 0,
        })),
  });
  ...
  const handleAddService = () => {
    setData({
      ...data,
      serviceList: [...data.serviceList, { service_id: "", price_service: "" }],
    });
  };
  ...
  const handleSubmit = (e, paymentType, Bank) => {
    ...
    if (data.serviceList.length < 1) {
      alert('Tambah Form Service +1 Dan Kosongkan Value Jika Tidak Ada Data!!');
      return;
    }

    if (data.productList.length < 1) {
        alert('Tambah Form Product +1 Dan Kosongkan Value Jika Tidak Ada Data!!');
        return;
    }
    ...
    <Authenticated user={auth}>
      ...
      <div className="py-12 px-4">
        <div className="w-full mx-auto sm:px-2 lg:px-4">
          ...
          >
            <h1 className="text-2xl font-semibold my-5">Detail Pelanggan</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-1">
              <div>
                <InputLabel htmlFor="name_owner" value="Nama Owner" />
                <TextInput
                  type="text"
                  className="block w-full"
                  placeholder="name_owner"
                  value={data.name_owner}
                  onChange={(e) => setData("name_owner", e.target.value)}
                  readOnly
                />
              </div>
              <div>
                ...
                <TextInput
                  ...
                  onChange={(e) => setData("name_hewan", e.target.value)}
                  readOnly
                />
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-1">
              <div>
                ...
                <TextInput
                  ...
                  readOnly
                />
                <InputError message={errors.invoice} className="mb-2" />
              </div>
              <div>
                <InputLabel htmlFor="date_transaction" value="Date Transaction" />
                <TextInput
                  type="text"
                  id="date_transaction"
                  ...
                  onChange={(e) => setData("date_transaction", e.target.value)}
                  readOnly
                />
                <InputError message={errors.date_transaction} className="mb-2" />
              </div>
            </div>
            ...
            <div>
              ...
              {data.serviceList.map((service, index) => (
                <div key={index} className="mb-4 flex items-center gap-2">
                  ...
                  <InputError message={errors.service_id} className="mb-2" />
                  ...
                  <TextInput
                    ...
                    readOnly
                  />
                  <InputError message={errors.price_service} className="mb-2" />
            ...
            <div>
              ...
              {data.productList.map((product, index) => (
                <div key={index} className="mb-4 flex items-center gap-2">
                  ...
                  >
                    ...
                    {products.map((productOption) => (
                      <option
                        ...
                        data-price={productOption.price_product}
                      >
                  ...
                  <InputError message={errors.product_id} className="mb-2" />
                  ...
                  />
                  <InputError message={errors.qty} className="mb-2" />
                  ...
                  <TextInput
                    ...
                    readOnly
                  />
                  <InputError message={errors.total_price} className="mb-2" />
            ...
            <div>
              ...
              <div className="mt-5">
                <h1 className="text-xl font-semibold mb-2">Subtotal</h1>
                <div className="flex justify-between items-center">
                  <div className="text-lg">Subtotal Transaction:</div>
                  <div className="text-lg">{formatCurr(subtotal)}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4 items-center justify-between">
              ...
              <Dropdown.Link onClick={(e) => handleSubmit(e, "tunai")}>Tunai</Dropdown.Link>
              <Dropdown.Divider />
              <Dropdown.Link onClick={(e) => handleSubmit(e, "gopay")}>Gopay</Dropdown.Link>
              <Dropdown.Link onClick={(e) => handleSubmit(e, "bank_transfer", "bca")}>BCA VA</Dropdown.Link>
              <Dropdown.Link onClick={(e) => handleSubmit(e, "bank_transfer", "bni")}>BNI VA</Dropdown.Link>
            </ButtonLink>
